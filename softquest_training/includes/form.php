...
class Form {
    ...
    protected static $db_fields = array('FORM_ID', 'FORM_TITLE', 'INSTRUCTIONS', 'COURSE_CODE');
    public $FORM_ID;
    public $FORM_TITLE;
    public $INSTRUCTIONS;
    public $COURSE_CODE;
...
public static function find_all() {
    ...
    public static function find_by_id($id = 0) {
        ...
        " WHERE FORM_ID='{$id}' LIMIT 1");
        return !empty($result_array) ? array_shift($result_array) : false;
    }

    public static function find_by_title($title) {
        $result_array = self::find_by_sql("SELECT * FROM " . self::$table_name . " WHERE FORM_TITLE='{$title}'");
    ...
    public function save() {
        ...
        return isset($this->FORM_ID) ? $this->update() : $this->create();
    }
